...
namespace QuizyZunaAPI.Persistence.Migrations
{
    ...
    [Migration("20240923194304_TimesAnsweredAdded")]
    partial class TimesAnsweredAdded
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("QuizyZunaAPI.Domain.Questions.ValueObjects.Answers", "Answers", b1 =>
                        {
                            ...
                            b1.OwnsOne("QuizyZunaAPI.Domain.Questions.ValueObjects.CorrectAnswer", "CorrectAnswer", b2 =>
                                {
                                    b2.Property<Guid>("AnswersQuestionId")
                                        .HasColumnType("uuid");

                                    b2.Property<int>("TimesAnswered")
